    ...
    <div class="content">
      <div class="content-area">
        <div class="pdf-actions" id="group-actions-id">
            ...
            <span class="resize" @click="fullView()">
              <img src="/src/assets/resize.png" />
            </span>

             <embed
              name="display-frame"
              :src="media + '#toolbar=0&navpanes=0&scrollbar=0'"
              style="width: 100%; height: 90vh; border: 2px solid #4e46e5"
            />
