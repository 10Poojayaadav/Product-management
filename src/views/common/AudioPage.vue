  ...
  <div class="video">
    <div class="_modal create-group group">
        ...
        <div v-else class="content-area">
          <div class="video-container" style="background-color:#1F2937">
        <button class="cross-btn text-black text-white" @click="$emit('close')">+</button>
            <div class="group-actions" id="video-actions-id">
              ...
              <ul v-if="group_actions" class="actions">
                ...
                <li @click="favourite(id)" v-if="audioInfo.favourite==true">Favourite</li>
             ...
             <p class="text-white audio-title">{{ audioInfo.title }}</p>
            <div class="audio-details">
              <img src="/src/assets/Voice.svg" class="svg">
              <img :src="audioInfo.thumbnail" height="180">
              <p class="text-white">{{ audioInfo.title }}</p>
            </div>
            <audio-player
              :autoplay="false"
              :muted="false"
          ...
          <div class="mymodal" id="Insightmodal">
            <div class="myform">
              ...
              <div class="form text-white">
                ...
                <div class="note-container" v-html="audioInfo.insight"></div>
              </div>
            </div>
          </div>
  ...
  methods: {
    audioContent() {
      axios.get("get-content/" + this.id).then((response) => {
        ...
        this.audio = response.data.data.media;
